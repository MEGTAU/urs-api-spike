...
class ExpressServer {
    ...
    setupMiddleware() {
        ...
        // Serve the generated API documentation at /api-docs
        this.app.use('/api-docs', express.static(path.join(__dirname, 'api-docs')));
        // Serve the interactive Swagger UI at /swagger-ui
        this.app.use('/swagger-ui', swaggerUI.serve, swaggerUI.setup(this.schema));
        //this.app.set('view engine', 'ejs');
        //this.app.set('views', 'ui-2/views');

        this.app.use(express.static(path.join(__dirname, 'public')));

        this.app.get('/', (req, res) => res.redirect('/demo.html'));
